...
public class ValidationUtils {
    ...
    public static void validateUser(UserDetails user) throws UserRegistrationException {
        if (user == null) {
    ...
    public static void validateClient(ClientDetails client) throws ClientRegistrationException {
        if (client == null) {
